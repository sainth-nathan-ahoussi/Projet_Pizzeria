  ...
  <?php
  	session_start();
		...
		foreach ($tableauIngredient as $Ingredient){
			...
			echo	'<div class="Heure"> <p>'.$Ingredient->get('NomIngredient').'</p> </div>';
			echo	'<div class="TypePaiement"> <p>'.$Ingredient->get('QuantiteStock').'</p> </div>';
			echo	'<div class="Statut"> <p>'.$Ingredient->get('SeuilAlerte').'</p> </div>';
			echo '</div>';
		}
